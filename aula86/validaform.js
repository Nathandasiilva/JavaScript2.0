class ValidaFormulario {
    ...
    handleSubmit(e) {
        e.preventDefault();
        const cammposValidos = this.camposSãoValidos();
        const senhasValidas = this.senhaSãoValidas();

        if(cammposValidos && senhasValidas) {
    ...
    validaUsuario(campo){
        ...
        if(!usuario.match(/^[a-zA-Z0-9]+$/g)) {
          this.criaErro(campo, 'Nome de usuario precisa contar apenas letras e/ou numeros');
          valid = false;
        }
